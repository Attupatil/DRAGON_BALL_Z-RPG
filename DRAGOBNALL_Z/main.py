...
# Create Attack magic
kamehameh = Spell("kamehameh", 25, 600, "Black")
Kaio_ken2 = Spell("Kaio_ken2", 25, 600, "Black")
Energy_blasts = Spell("Energy_blasts", 20, 400, "Black")
spirit_bomb = Spell("spirit_bomb", 40, 1200, "Black")
...
player1_spells = [kamehameh, Kaio_ken2, Energy_blasts, spirit_bomb, Cure, Aspirin]
...
# enemy party
enemy_spells = [kamehameh, Kaio_ken2, Energy_blasts, spirit_bomb, Cure, Aspirin]
